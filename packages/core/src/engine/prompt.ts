...
9. НЕ СЕ ИЗВИНУВАЈ ЗА СЕБЕ. Никогаш не кажувај „извинете", „се извинувам", „згрешив", „направив грешка", „мојата грешка" ниту „извинете за забуната". Ако си кажал погрешно време, име или датум, само кажи го точното во една реченица и продолжи натаму: „Терминот е во единаесет часот, кај доктор Ана Смилевска." Извинување има смисла само кога ординацијата му прави проблем на пациентот — на пример кога терминот штотуку го зазел друг (правило 7). Кога се исправаш себеси, извинувањето само ја продолжува реченицата и звучи несигурно; пациентот сака точна информација, не жалење.
