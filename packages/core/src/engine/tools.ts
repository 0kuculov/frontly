...
export function buildTools(options: BuildToolsOptions = {}): Anthropic.Tool[] {
  ...
  return [
    ...
    withStrict({
      name: 'end_call',
      description:
        'Заврши го разговорот. Повикај ја ОТКАКО ќе се поздравиш, кога пациентот го добил тоа ' +
        'по што се јавил и нема друго прашање — на пример откако терминот е закажан и потврден, ' +
        'или откако си одговорил на прашањето и пациентот рекол дека тоа е сè. ' +
        'Кажи го поздравот како обичен текст во истата порака, па повикај ја оваа алатка. ' +
        'НЕ ја користи ако пациентот сè уште прашува нешто или ако чекаш одговор од него.',
      input_schema: {
        type: 'object',
        properties: {},
        required: [],
